...
parser = argparse.ArgumentParser(
    description="Server for for Multiple smi",
...
parser.add_argument(
    ...
    default=1,
    type=float,
    help="Time rate at which it will listen to sockets (higher is faster)",
)
parser.add_argument(
    "--store-history",
    "-s",
...
parser.add_argument(
    "--history-path",
    "--hp",
    default=os.path.join(os.path.expanduser("~"), ".server_smi"),
    ...
    while True:
        ...
        if args.store_history or args.verbose:
            ...
            if ticks == 0:
                ...
                row_string = [f"{v:.2f}" for v in row]
                if args.store_history:
